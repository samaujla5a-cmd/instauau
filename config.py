...
# ── Music Style: Desi Trap / Hindi-English Rap ────────────────────────────────
# References: Divine, Seedhe Maut, Emiway Bantai, Kr$na, Prabh Deep vibe
# Mix: Hindi slang + English bars, street wisdom, real talk
MUSIC_STYLE = {
    "genre": "desi trap hip-hop",
    "vibe": "desi trap, hindi-english mix, street rap, hard hitting 808s, dark atmospheric",
    "mood": "confident, raw, real, hustler mentality, introspective desi",
    "language": "Hinglish (Hindi + English mix) — use Hindi words naturally mixed with English bars",
